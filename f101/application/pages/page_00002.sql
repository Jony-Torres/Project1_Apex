...
,p_name=>'Referencias del sistema'
,p_alias=>'REFERENCIAS-DEL-SISTEMA'
,p_step_title=>'Referencias del sistema'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(5322694370144102)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JTORRES'
,p_last_upd_yyyymmddhh24miss=>'20210817192641'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6312419176259639)
