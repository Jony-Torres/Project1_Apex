...
,p_name=>unistr('Gesti\00F3n Cobros')
,p_alias=>unistr('GESTI\00D3N-COBROS')
,p_step_title=>unistr('Gesti\00F3n Cobros')
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(5322694370144102)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JTORRES'
,p_last_upd_yyyymmddhh24miss=>'20210818191720'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6408557009162504)
