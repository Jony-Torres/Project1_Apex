...
,p_name=>unistr('Ventas y Facturaci\00F3n')
,p_alias=>unistr('VENTAS-Y-FACTURACI\00D3N')
,p_step_title=>unistr('Ventas y Facturaci\00F3n')
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(5322694370144102)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JTORRES'
,p_last_upd_yyyymmddhh24miss=>'20210818192451'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6410378625207597)
