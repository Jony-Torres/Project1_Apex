...
,p_name=>unistr('Gesti\00F3n Pagos')
,p_alias=>unistr('GESTI\00D3N-PAGOS')
,p_step_title=>unistr('Gesti\00F3n Pagos')
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(5322694370144102)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JTORRES'
,p_last_upd_yyyymmddhh24miss=>'20210818193100'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6412141303244558)
