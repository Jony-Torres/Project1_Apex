...
,p_name=>'reportes_clientes'
,p_alias=>'REPORTES-CLIENTES'
,p_step_title=>'reportes_clientes'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(5322694370144102)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JTORRES'
,p_last_upd_yyyymmddhh24miss=>'20210823194600'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6930256747256660)
