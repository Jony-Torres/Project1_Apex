...
,p_name=>'mantenimiento_compras'
,p_alias=>'MANTENIMIENTO-COMPRAS'
,p_step_title=>'mantenimiento_compras'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(5322694370144102)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JTORRES'
,p_last_upd_yyyymmddhh24miss=>'20210916194928'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8236898908123754)
