...
,p_name=>'reportes_compras'
,p_alias=>'REPORTES-COMPRAS'
,p_step_title=>'reportes_compras'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JTORRES'
,p_last_upd_yyyymmddhh24miss=>'20210916195058'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(8238382612132705)
