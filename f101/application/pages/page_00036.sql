...
,p_name=>'mantenimiento_ventas'
,p_alias=>'MANTENIMIENTO-VENTAS'
,p_step_title=>'mantenimiento_ventas'
,p_autocomplete_on_off=>'OFF'
,p_group_id=>wwv_flow_api.id(5322694370144102)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JTORRES'
,p_last_upd_yyyymmddhh24miss=>'20211028202402'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10242176422070310)
