...
,p_alias=>'LOGIN'
,p_step_title=>'Project1 - Conectar'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(5187656894143548)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5323563450144143)
,p_plug_name=>'Project1'
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5233658512143730)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5328135325144196)
,p_plug_name=>'Selector de Idioma'
,p_parent_plug_id=>wwv_flow_api.id(5323563450144143)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5326307396144173)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(5323563450144143)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5323965461144167)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5323563450144143)
...
,p_field_template=>wwv_flow_api.id(5295661478143910)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5324364454144171)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5325426339144172)
...
,p_lov=>'.'||wwv_flow_api.id(5324636796144171)||'.'
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5327113549144188)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5326797063144178)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5327826496144196)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5327481846144188)
,p_process_sequence=>10
