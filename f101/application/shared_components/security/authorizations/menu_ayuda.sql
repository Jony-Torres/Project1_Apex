prompt --application/shared_components/security/authorizations/menu_ayuda
begin
--   Manifest
--     SECURITY SCHEME: MENU AYUDA
--   Manifest End
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(26830643667375327)
,p_name=>'MENU AYUDA'
...
'end;'))
,p_error_message=>unistr('El esquema de autorizaci\00F3n del Men\00FA Ayuda, fue violado.')
