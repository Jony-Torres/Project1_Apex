prompt --application/shared_components/security/authorizations/menu_compras
begin
--   Manifest
--     SECURITY SCHEME: MENU COMPRAS
--   Manifest End
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(26834680312704383)
,p_name=>'MENU COMPRAS'
...
'end;'))
,p_error_message=>unistr('El esquema de autorizaci\00F3n del Men\00FA de Compras, fue violado.')
