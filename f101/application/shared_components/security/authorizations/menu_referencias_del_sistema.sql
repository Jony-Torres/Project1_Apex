prompt --application/shared_components/security/authorizations/menu_referencias_del_sistema
begin
--   Manifest
--     SECURITY SCHEME: MENU REFERENCIAS DEL SISTEMA
--   Manifest End
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(25923274298528910)
,p_name=>'MENU REFERENCIAS DEL SISTEMA'
...
'end;'))
,p_error_message=>unistr('El esquema de autorizaci\00F3n del Men\00FA Referencias del sistema fue violado.')
