prompt --application/shared_components/security/authorizations/menu_ventas
begin
--   Manifest
--     SECURITY SCHEME: MENU VENTAS
--   Manifest End
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(26832118210623693)
,p_name=>'MENU VENTAS'
...
'end;'))
,p_error_message=>unistr('El esquema de autorizaci\00F3n del Men\00FA Ventas, fue violado.')
